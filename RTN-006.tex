...
\setDocChangeRecord{%
  ...
  \addtohist{1.3}{2025-04-15}{Deduplicate Forum-related content and cite RTN-097.}{Melissa Graham}
}
...
All of the components of this model for community science described in \S~\ref{sec:mod} are designed to support scientific endeavors.

Technical support and service access issues are also part of user support (e.g., account authentication, lost passwords, gateway timeouts) and while these will always be welcome via the Rubin Community Forum, a separate venue might also be provided (e.g., GitHub Issues).
...
Since a traditional (closed) Help Desk support interface could become a bottleneck, Rubin Observatory will instead build its user support on the open Discourse platform and maintain the Rubin Community Forum (\url{Community.lsst.org}).
This platform allows Rubin staff to monitor user support requests while simultaneously building an online community with the ability to crowd-source solutions from a deep reservoir of collected expertise.
...
Guidelines for providing user support with the Rubin Community Forum can be found in RTN-097\footnote{\url{https://rtn-097.lsst.io/}}.
\begin{itemize}
\item goals, metrics, and principles of user support
\item how to respond effectively to user questions
\item how to provide confidential support
\item tips for sharing news and announcements
\item categories for enabling scientific discussion
\item advice for Science Collaboration chairs
\item Forum terminology
\end{itemize}


\subsubsection{Future evolution of the Forum}
...
For best practices related to facilitating scientific discussions, and policies related to time-domain research annoucements, see RTN-097\footnote{\url{https://rtn-097.lsst.io/}}.
...
\paragraph{Accessibility Reviews}

The CST will conduct accessibility reviews of the RSP every three years to evaluate user-facing tools and documentation, ensuring they meet the needs of users with accessibility requirements.
These reviews will incorporate recommendations from previous evaluations and adapt to the evolution of tools and community needs.
External consultants with domain expertise in astronomy and accessibility will be engaged for a holistic assessment.
The reviews will aim to identify improvements for the accessibility of the RSP’s API, Notebook, and Portal aspects and associated documentation.
