...
\setDocAbstract{%
A preliminary model for community engagement in science with the Rubin Observatory.
}
...
\item \textbf{Data rights holders} are individuals with the right to access, analyze, and publish work based on the Rubin Observatory proprietary data products and services, as described in \citedp{rdo-013}. The term \textbf{LSST user} or just \textbf{user} represents a data rights holder using the Rubin Observatory data products or services, in particular the Rubin Science Platform \citedsp{lse-319}.
\end{itemize}
